...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <form action="pictureView" method="get">
        <div class="providerView">
            <div class="providerViewLeftbox">
                <c:forEach items="${pictureSingle}" var="sigle"></c:forEach>
                <p><strong>图片编号：</strong><span>${pictureSingle.pcode}</span></p>
            <p><strong>文件名称：</strong><span>${pictureSingle.pname}</span></p>
